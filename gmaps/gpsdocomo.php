...
if($lat == "" || $lon == "" || $smaj == "")
    ...
    echo "<a href='mailto:".$mail."?body=GPS誤差レベル(DoCoMo):".$smaj."%0D%0A&#60;cmd src=\"gmaps\" args=\"17,".$laaa.",".$looo."\"&#62;'>下記マップでメール作成</a><br>";
    echo "<a href='../../kmaps.php?$laa&amp;$loo&amp;III'>マップを確認</a><br>";
    echo "<a href='".OPENPNE_URL."gmaps/gpsau.php/".$ksid."/".$mail."' lcs>再計測</a><br>";
