...
<div><a href="({t_url m=diary a=page_detail})&amp;target_c_diary_id=({$item.c_diary_id})"><img src="./skin/dummy.gif" style="width:14px;height:14px;" class="icon icon_1">({$item.subject})</a></div>
...
<a href="({t_url m=diary a=page_detail})&amp;target_c_diary_id=({$item.c_diary_id})"><img src="./skin/dummy.gif" style="width:14px;height:14px;" class="icon icon_3">({$item.subject})</a><br>
({/foreach})
</div>
<!-- ここまで：主内容 -->
({*ここまで：body*})
