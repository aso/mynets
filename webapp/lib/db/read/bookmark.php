...
function db_bookmark_diary_list_with_pager($c_member_id, $page_size, $page)
{
    ...
    $sql = 'SELECT ' . MYNETS_PREFIX_NAME . 'c_diary.* FROM ' . MYNETS_PREFIX_NAME . 'c_diary, ' . MYNETS_PREFIX_NAME . 'c_member WHERE ' . MYNETS_PREFIX_NAME . 'c_diary.c_member_id IN ('.$ids.') AND ((' . MYNETS_PREFIX_NAME . 'c_diary.public_flag = \'public\') OR (' . MYNETS_PREFIX_NAME . 'c_diary.public_flag = \'default\' AND ' . MYNETS_PREFIX_NAME . 'c_member.public_flag_diary in (\'public\',\'open\'))) AND ' . MYNETS_PREFIX_NAME . 'c_diary.c_member_id=' . MYNETS_PREFIX_NAME . 'c_member.c_member_id ORDER BY r_datetime DESC';
