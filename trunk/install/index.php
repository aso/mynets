...
<div id="wrap">
  <div id="head-install">
    ...
    <div id="head-menu">
      <ul class="menu">
        <li><a href="http://usagi.mynets.jp">UsagiProject公式サイト</a></li>
        <li><a href="http://usagi.mynets.jp/SBBS/">サポート掲示板</a></li>
        <li><a href="http://usagi.mynets.jp/SNS100/">デモサイトSNS</a></li>
      </ul>
    </div>
  </div>
  <div id="content">
    <div id="main-body">
      <div class="entry-box">
        ...
        <div class="entry-body">
          <p>UsagiProjectへようこそ</p>
          <p>UsagiProjectのSNSエンジン「MyNETS Version 1.2.0」をインストールするためのツールがインストーラーです。このツールは新規でMyNETS Version 1.2.0を導入するするためのツールです。</p>
          ...
          <br />
          <br />
          <p class="center"><img src="./images/back_img.jpg" alt="UsagiProject"  /></p>
        </div>
      </div>
      <div class="entry-box">
        ...
        <div class="entry-body">
          ...
          <p>処理の流れは次のようになります。</p>
          <ul>
            <li><a href="#" onmouseout="hideTooltip()" onmouseover="showTooltip(event,'まずは公式サイトからMyNETS 1.2.0をDLして自分のマシンで展開しておきましょう。今回のバージョンアップはフォルダーの構成等が変わっていますので、すべてのファイルを用意してください。');return false">MyNETS 1.2.0 アプリケーションファイルの準備</a></li>
            <li><a href="#" onmouseout="hideTooltip()" onmouseover="showTooltip(event,'導入予定のサーバーの情報を準備しておいてください。どのようなURLえSNSサイトを動かすのか、などインストールのためには情報が必要になります。');return false">サーバー情報の準備</a></li>
      ...
      <div class="entry-box">
        ...
        <div class="entry-body">
          ...
          <p>スクリプトチェックツールを UsagiProject 公式サイト、またはソースフォージからダウンロードして、サーバーに転送します。</p>
          <p>すべてのファイルが正しくアップロードできたか確認してください。</p>
          <p>MyNETS Version 1.2.0の大きな特徴として、public_htmlフォルダーを廃止し、ドメインでそのままSNSが動かせるように変更しました。<br />そのため、以前のファイルが残ったままファイルを転送しますと、思いもよらない不具合が出る可能性があります。必ずすべてのファイルを入れ替えるようにしてください。</p>
          <br />
  ...
  <div id="foot">
    ...
    <div id="copyright">
      <p>COPYRIGHT Usagi Project All Rights reserved. -2007</p>
    </div>
  </div>
</div>
</body>
