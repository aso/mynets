...
function db_common_receive_pc_address_list4c_commu_id($c_commu_id)
{
    $sql = "SELECT m.pc_address" .
            " FROM " . MYNETS_PREFIX_NAME . "c_member_secure AS m, " . MYNETS_PREFIX_NAME . "c_commu_member AS cm" .
            " WHERE cm.c_commu_id = ?".
...
{
    $sql = "SELECT cac.*, c.c_member_id_admin FROM " . MYNETS_PREFIX_NAME . "c_commu_admin_confirm AS cac, " . MYNETS_PREFIX_NAME . "c_commu AS c";
...
{
    $sql = 'SELECT c_member_id FROM ' . MYNETS_PREFIX_NAME . 'c_commu_member WHERE c_commu_id = ? ORDER BY r_datetime DESC';
    $params = array(intval($c_commu_id));
...
{
    $sql = "SELECT " . MYNETS_PREFIX_NAME . "c_commu.c_commu_id, " . MYNETS_PREFIX_NAME . "c_commu.image_filename, " . MYNETS_PREFIX_NAME . "c_commu.name" .
        " FROM " . MYNETS_PREFIX_NAME . "c_commu ," . MYNETS_PREFIX_NAME . "c_commu_member " .
        " WHERE " . MYNETS_PREFIX_NAME . "c_commu_member.c_member_id = ?".
        " AND " . MYNETS_PREFIX_NAME . "c_commu.c_commu_id =  " . MYNETS_PREFIX_NAME . "c_commu_member.c_commu_id" .
        " ORDER BY RAND()";
    $params = array(intval($c_member_id));
    $lst = db_get_all_limit($sql, 0, $limit, $params);
...
function p_h_confirm_list_anatani_c_commu_member_confirm_list4c_member_id($c_member_id)
{
    ...
    $sql .= " FROM " . MYNETS_PREFIX_NAME . "c_commu_member_confirm AS cmc, " . MYNETS_PREFIX_NAME . "c_commu AS c";
...
function p_h_confirm_list_anatani_c_commu_admin_confirm_list4c_member_id($c_member_id_to)
{
    ...
    $sql .= " FROM " . MYNETS_PREFIX_NAME . "c_commu_admin_confirm AS cac, " . MYNETS_PREFIX_NAME . "c_commu AS c";
...
function p_h_home_c_commu_topic_comment_list4c_member_id($c_member_id, $limit)
{
    ...
    $sql .= " cc.event_flag as event FROM ".MYNETS_PREFIX_NAME."c_commu_topic as cc,".MYNETS_PREFIX_NAME."c_commu_member as cm WHERE cm.c_member_id = ? ";
...
{
    $sql = "SELECT cc.c_commu_topic_id, c.name AS c_commu_name, ct.name AS c_commu_topic_name , cm.c_member_id, cc.number, max(cc.r_datetime) as r_datetime, ct.event_flag AS event";
    $sql .= " FROM " . MYNETS_PREFIX_NAME . "c_commu_member AS cm, " . MYNETS_PREFIX_NAME . "c_commu_topic_comment AS cc";
...
{
    $sql = "SELECT c.* FROM " . MYNETS_PREFIX_NAME . "c_commu_member AS cm, " . MYNETS_PREFIX_NAME . "c_commu AS c";
    $sql .= " WHERE cm.c_member_id=?";
    $sql .= " AND c.c_commu_id=cm.c_commu_id";
    $sql .= " ORDER BY RAND()";
    $params = array(intval($c_member_id));
...
function p_c_topic_list_c_topic_list4target_c_commu_id($c_commu_id, $c_member_id, $page = 1, $page_size = 10, $event_flag = 0, $topic_with_event = 0)
{
    $sql = " SELECT cct.c_commu_topic_id, max(cctc.r_datetime) as newest_write_datetime " .
            " FROM " . MYNETS_PREFIX_NAME . "c_commu_topic as cct, " . MYNETS_PREFIX_NAME . "c_commu_topic_comment as cctc " .
...
{
    $sql = "SELECT ct.*, ctc.*, " . MYNETS_PREFIX_NAME . "c_member.nickname, " . MYNETS_PREFIX_NAME . "c_member.image_filename" .
...
function _db_common_c_commu_topic_comment4c_commu_topic_comment_id($c_commu_topic_comment_id)
{
    $sql = "SELECT ctc.*, ct.name AS topic_name, c.name AS commu_name" .
        " FROM " . MYNETS_PREFIX_NAME . "c_commu_topic_comment AS ctc, " . MYNETS_PREFIX_NAME . "c_commu_topic AS ct, " . MYNETS_PREFIX_NAME . "c_commu AS c" .
...
{
    $sql = 'SELECT DISTINCT c.* FROM ' . MYNETS_PREFIX_NAME . 'c_commu_member AS cm, ' . MYNETS_PREFIX_NAME . 'c_commu AS c' .
 ...
 */
function k_p_c_bbs_c_commu_topic_comment_list4c_c_commu_topic_id($c_commu_topic_id, $c_member_id, $page_size, $page, $sort_order = '')
{
    $sql = "SELECT " . MYNETS_PREFIX_NAME . "c_commu_topic_comment.*, " . MYNETS_PREFIX_NAME . "c_member.nickname" .
        " FROM " . MYNETS_PREFIX_NAME . "c_commu_topic_comment" .
            " LEFT JOIN " . MYNETS_PREFIX_NAME . "c_member USING (c_member_id)" .
...
{
    $sql = "SELECT cc.c_commu_id , cc.name FROM " . MYNETS_PREFIX_NAME . "c_commu_topic AS cct," . MYNETS_PREFIX_NAME . "c_commu AS cc ";
...
{
    $sql = "SELECT name, " . MYNETS_PREFIX_NAME . "c_commu.c_commu_id FROM " . MYNETS_PREFIX_NAME . "c_commu_member , " . MYNETS_PREFIX_NAME . "c_commu";
    $sql .= " WHERE " . MYNETS_PREFIX_NAME . "c_commu_member.c_member_id = ?";
    $sql .= " AND " . MYNETS_PREFIX_NAME . "c_commu.c_commu_id=" . MYNETS_PREFIX_NAME . "c_commu_member.c_commu_id";
    $sql .= " ORDER BY " . MYNETS_PREFIX_NAME . "c_commu.c_commu_id DESC ";
...
function k_p_c_home_c_commu_member_list_random4c_commu_id($c_commu_id, $limit)
{
    ...
    $sql .= "FROM " . MYNETS_PREFIX_NAME . "c_member AS cm , " . MYNETS_PREFIX_NAME . "c_commu_member AS ccm ";
            ...
            $c_commu_category_id = 0)
{
    ...
    if ($search_word) {
        ...
        foreach ($words as $word) {
            ...
            $where .= ' AND (' . MYNETS_PREFIX_NAME . 'c_commu.name LIKE ? OR ' . MYNETS_PREFIX_NAME . 'c_commu.info LIKE ?)';
            $params[] = '%'.$word.'%';
            $params[] = '%'.$word.'%';
        }
    }
    ...
    case 'count':
        $from  = ' FROM ' . MYNETS_PREFIX_NAME . 'c_commu, ' . MYNETS_PREFIX_NAME . 'c_commu_member';
        ...
        $sql = $select . ', COUNT(' . MYNETS_PREFIX_NAME . 'c_commu_member.c_member_id) AS count_commu_member' .
            $from .
            $where . ' AND ' . MYNETS_PREFIX_NAME . 'c_commu_member.c_commu_id = ' . MYNETS_PREFIX_NAME . 'c_commu.c_commu_id' .
            $group .
            $order;
        break;
    }
...
function c_event_detail_c_topic4c_commu_topic_id($c_commu_topic_id)
{
    $sql = "SELECT cct.*, cctc.*, cm.nickname,cm.image_filename, cpp.pref" .
        ...
        " LEFT JOIN " . MYNETS_PREFIX_NAME . "c_commu_topic_comment as cctc ON cct.c_commu_topic_id = cctc.c_commu_topic_id" .
        " LEFT JOIN " . MYNETS_PREFIX_NAME . "c_member as cm ON cct.c_member_id = cm.c_member_id" .
        " LEFT JOIN " . MYNETS_PREFIX_NAME . "c_profile_pref as cpp ON cct.open_pref_id = cpp.c_profile_pref_id" .
...
{
    $sql = "SELECT ctc.*, " . MYNETS_PREFIX_NAME . "c_member.nickname , " . MYNETS_PREFIX_NAME . "c_member.image_filename" .
...
{
    $sql = "SELECT cm.* FROM " . MYNETS_PREFIX_NAME . "c_member as cm, " . MYNETS_PREFIX_NAME . "c_event_member as cem" .
...
{
    $sql = "SELECT COUNT(*) FROM " . MYNETS_PREFIX_NAME . "c_member as cm, " . MYNETS_PREFIX_NAME . "c_event_member as cem" .
            " WHERE cm.c_member_id = cem.c_member_id" .
            " AND cem.c_commu_topic_id = ?";
    $params = array(intval($c_commu_topic_id));
    return db_get_one($sql, $params);
...
{
    $sql = 'SELECT c_commu_topic_comment_id from ' . MYNETS_PREFIX_NAME . 'c_commu_topic_comment WHERE c_commu_topic_id = ? AND number = ?';
...
{
    $today = date("Y-m-d", strtotime(db_now())-5184000);
    $sql = "SELECT ".MYNETS_PREFIX_NAME."c_commu_topic_id FROM c_commu_topic WHERE c_commu_id = ? ";
    $params = array(intval($c_commu_id));
    $ids = db_get_col($sql, $params);
    $ids = implode(", ", $ids);
    $sql = "SELECT count(*) FROM ".MYNETS_PREFIX_NAME."c_access_log WHERE (target_c_commu_id = ? ";
    $sql .= " OR target_c_commu_topic_id in ($ids)) ";
