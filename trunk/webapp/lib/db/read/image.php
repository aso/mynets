...
function db_admin_c_image_list($page, $page_size, &$pager)
{
    ...
    */
    /**/
    $sql = 'SELECT c_image_id,filename,r_datetime FROM ' . MYNETS_PREFIX_NAME . 'c_image ORDER BY c_image_id DESC';
    $c_image_list = db_get_all_limit($sql, ($page-1)*$page_size, $page_size);
