...
<div class="pager">
    ...
    <br>
    ({if $pager.prev_page})
        <a href="?m=({$module_name})&amp;a=page_({$hash_tbl->hash('to_from_message_check')})&amp;page=({$pager.prev_page})&amp;page_size=({$pager.page_size})&amp;c_member_id_from=({$c_member_id_from})&amp;c_member_id_tom=({$c_member_id_to})">前へ</a>&nbsp;
    ({/if})
    ({foreach from=$pager.disp_pages item=i})
        ({if $i == $pager.page})
            &nbsp;<strong>({$i})</strong>&nbsp;
        ({else})
            <a href="?m=({$module_name})&amp;a=page_({$hash_tbl->hash('to_from_message_check')})&amp;page=({$i})&amp;page_size=({$pager.page_size})&amp;c_member_id_from=({$c_member_id_from})&amp;c_member_id_tom=({$c_member_id_to})">&nbsp;({$i})&nbsp;</a>
        ({/if})
    ({/foreach})
    ({if $pager.next_page})
        &nbsp;<a href="?m=({$module_name})&amp;a=page_({$hash_tbl->hash('to_from_message_check')})&amp;page=({$pager.next_page})&amp;page_size=({$pager.page_size})&amp;c_member_id_from=({$c_member_id_from})&amp;c_member_id_tom=({$c_member_id_to})">次へ</a>
    ({/if})
</div>
<!-- pager_end -->
