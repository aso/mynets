...
'info':'({$diary.subject|strip|replace:"\\":"\\\\"|replace:"&#039;":"\'"|t_body:'title'})({if $diary.comment_number != "top"})(コメント({$diary.comment_number}))({else})(日記)({/if})({if $diary.comment_number != "top"}) - ({$diary.body|strip|t_truncate:30:"…"|replace:"\\":"\\\\"|replace:"&#039;":"\'"|t_body:'title'})({/if})',
'note':'({$diary.body|strip|t_truncate:90:"…"|replace:"\\":"\\\\"|replace:"&#039;":"\'"|t_body:'title'})',
...
'info':'({$topic.communame|strip|replace:"\\":"\\\\"|replace:"&#039;":"\'"|t_body:'title'}) - ({$topic.commutopicname|strip|replace:"\\":"\\\\"|replace:"&#039;":"\'"|t_body:'title'})({if $topic.number})(書込({$topic.number}))({elseif $topic.event_flag})(イベント)({else})(トピック)({/if})({if $topic.number}) - ({$topic.body|strip|t_truncate:30:"…"|replace:"\\":"\\\\"|replace:"&#039;":"\'"|t_body:'title'})({/if})',
'note':'({$topic.body|strip|t_truncate:90:"…"|replace:"\\":"\\\\"|replace:"&#039;":"\'"|t_body:'title'})',
