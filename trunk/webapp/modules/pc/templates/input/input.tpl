...
-->
    ...
    <tr>
        ...
        ({if $smarty.const.MYNETS_OPEN_DIARY})
            <input type="radio" name="public_flag" value="open"({if $form_val.public_flag == "open"}) checked="checked"({/if}) class="no_bg" id="public_flag_public"><label for="public_flag_public">外部公開</label><br>
        ({/if})
