...
<div class="border_07 bg_02" style="margin-bottom:5px;" id="item_8">
    ...
    <div id="cnt8" style="display:none">
        ...
        <div style="padding:5px 10px 0 10px">
            ...
            ({$item.r_datetime|date_format:"%m月%d日"})…&nbsp;<a href="({$item.link})" target="_blank">({$item.subject|t_truncate:40|t_body:'title'})</a>
        </div>
        ({/foreach})
        <div style="text-align:right;padding:5px;">
        ...
        <div style="padding:5px 10px 0 10px">
            ...
            ({$item.r_datetime|date_format:"%m月%d日"})…&nbsp;<a href="({t_url m=pc a=page_h_review_list_product})&amp;c_review_id=({$item.c_review_id})">({$item.title|t_truncate:40})</a>
        </div>
        ({/foreach})
        <div style="text-align:right;padding:5px;">
